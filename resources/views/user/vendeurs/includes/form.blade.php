<div class="row">
   <!--  <form action="{ {route('user.updateInfosPerso')}}" method="post" class="row col-12"> -->
        ...
        <div class="offset-sm-1 col-5 form-group row">
            ...
            <input tabindex="1" class="form-control" name="prenom" id="prenom" type="text" value="{{old('prenom',$user->prenom)}}">
        </div>
        <div class="offset-sm-1 col-5 form-group row">
            <label for="Région de résidence:" class="col-sm-12 col-md-12">Région de résidence :</label>
            <select  tabindex="2" name="region_id" id="region_id" class="form-control">
                <option value=""> --- </option>
        ...
        <div class="offset-sm-1 col-5 form-group row">
            ...
            <input tabindex="3" class="form-control" id="name" name="name" type="text" value="{{ old('name', $user->name) }}">
        </div>
        <div class="offset-sm-1 col-5 form-group row">
            <label for="city_id" class="col-sm-12 col-md-12">Ville de résidence :</label>
            <select  tabindex="4" name="city_id" id="city_id" class="form-control">
                <option value=""> --- </option>
        ...
        <div class="offset-sm-1 col-5 form-group row">
            <label for="email" class="col-sm-12 col-md-12">Adresse e-mail :* <br><small>L'utilisateur recevra un message à cette adresse avec tous les détails d'authentification</small></label>
            <input  tabindex="5" class="form-control" id="email" name="email" type="text" value="{{ old('email', $user->email) }}">
        </div>
        <div class="offset-sm-1 col-5 form-group row">
            <label for="postal_code" class="col-sm-12 col-md-12">Code postal :</label>
            <input  tabindex="6" class="form-control" name="postal_code" id="postal_code" type="text" value="{{old('postal_code',$user->postal_code)}}">
        </div>
        <div class="offset-sm-1 col-5 form-group row">
        ...
        <div class="offset-sm-1 col-5 form-group row">
            ...
            <input  tabindex="7" class="form-control" id="num_civique" name="num_civique" type="text" value="{{old('num_civique', $user->num_civique)}}">
        </div>
        <div class="offset-sm-1 col-5 form-group row">
            <label for="age_group" class="col-sm-12 col-md-12">Groupe d'age :</label>
            <select  tabindex="8" name="age_group" id="age_group" class="form-control">
                <option value=""> --- </option>
        ...
        <div class="offset-sm-1 col-5 form-group row">
            ...
            <input  tabindex="9" class="form-control" name="street" id="street" type="text" value="{{old('street',$user->street)}}">
        </div>
        <div class="offset-sm-1 col-5 form-group row">
             <label for="num_tel" class="col-sm-12 col-md-12">Numéro de téléphone :</label>
            <input  tabindex="10" class="form-control phone_number" id="num_tel" name="num_tel" type="text" value="{{old('num_tel',$user->num_tel)}}">
        </div>
        <div class="offset-sm-1 col-5 form-group row mt-4">
        ...
        <div class="offset-sm-1 col-5 form-group row">
            ...
            <input  tabindex="11" class="form-control phone_number" id="mobile_phone" name="mobile_phone" type="text" value="{{old('mobile_phone', $user->mobile_phone)}}">
        </div>
        <div class="offset-sm-1 col-5 form-group row">
