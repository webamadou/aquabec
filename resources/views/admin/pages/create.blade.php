            ...
            <div class="card">
                ...
                <div class="card-body row">
                    ...
                    <div class="form-group col-sm-12 col-md-12" id="faqs-page">
                        ...
                        @php $i = 0; @endphp
                        <div class="col-12">
                            <a href="#" class="mx-2 text-sm btn btn-primary btn-sm add-faqg" data-toggle="modal" data-target="#faq-add-title" data-route="{{ route('admin.settings.faq_groups.store',@$faq->id) }}" data-page_id="{{$page->id}}" data-position="{{$page->faq_groups->count() + 1}}"><i class="fa fa-user-times"></i> Ajouter un titre </a>
                        </div>
                        <div id="faqgs">
