...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            ['name' =>'Accepter des evenements', 'permission_group' => 'events'],
            ['name' =>'Supprimer des evenements', 'permission_group' => 'events'],
            ['name' =>'Éditer des evenements', 'permission_group' => 'events'],
